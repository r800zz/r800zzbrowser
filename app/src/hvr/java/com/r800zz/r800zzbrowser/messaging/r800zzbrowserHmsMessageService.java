package com.r800zz.r800zzbrowser.messaging;
...
public class r800zzbrowserHmsMessageService extends HmsMessageService {

    private static final String HVR_APP_ID = BuildConfig.HVR_APP_ID;
    private static final String TOKEN_SCOPE = "HCM";

    public static final String COMMAND = "r800zzbrowserHmsMessageService.command";
    ...
    public static final String MESSAGE_RECEIVED_ACTION = "r800zzbrowserHmsMessageService.messageReceived";
        ...
        public void handleMessage(Message msg) {
            switch (msg.arg1) {
                case COMMAND_AUTO_INIT:
                    HmsMessaging.getInstance(r800zzbrowserHmsMessageService.this).setAutoInitEnabled(true);
                    break;
    ...
    public r800zzbrowserHmsMessageService() {
        super();
    }
