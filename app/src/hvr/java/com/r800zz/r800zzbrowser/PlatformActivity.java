...
import com.r800zz.r800zzbrowser.geolocation.HVRLocationManager;
import com.r800zz.r800zzbrowser.messaging.r800zzbrowserHmsMessageService;
import com.r800zz.r800zzbrowser.speech.SpeechRecognizer;
import com.r800zz.r800zzbrowser.speech.SpeechServices;
import com.r800zz.r800zzbrowser.telemetry.HVRTelemetry;
import com.r800zz.r800zzbrowser.telemetry.TelemetryService;
import com.r800zz.r800zzbrowser.ui.adapters.SystemNotification;
import com.r800zz.r800zzbrowser.ui.widgets.SystemNotificationsManager;
...
public abstract class PlatformActivity extends FragmentActivity implements SurfaceHolder.Callback, WidgetManagerDelegate {
    ...
    private void handlemHmsMessageBroadcast(Intent intent) {
        if (!r800zzbrowserHmsMessageService.MESSAGE_RECEIVED_ACTION.equals(intent.getAction()))
            return;

        RemoteMessage message = intent.getParcelableExtra(r800zzbrowserHmsMessageService.MESSAGE_EXTRA);
    ...
    private void showPhoneUI() {
        ...
        setTheme(R.style.Theme_r800zzbrowserPhone);
    ...
    private void enablePrivacySensitiveServices() {
        ...
        filter.addAction(r800zzbrowserHmsMessageService.MESSAGE_RECEIVED_ACTION);
    ...
    private void setHmsMessageServiceAutoInit(boolean enabled) {
        ...
        Intent intent = new Intent(this, r800zzbrowserHmsMessageService.class);
        intent.putExtra(r800zzbrowserHmsMessageService.COMMAND, r800zzbrowserHmsMessageService.COMMAND_AUTO_INIT);
        intent.putExtra(r800zzbrowserHmsMessageService.ENABLED_EXTRA, enabled);
        startService(intent);
    }
    ...
    private void getHmsMessageServiceToken() {
        ...
        Intent intent = new Intent(this, r800zzbrowserHmsMessageService.class);
        intent.putExtra(r800zzbrowserHmsMessageService.COMMAND, r800zzbrowserHmsMessageService.COMMAND_GET_TOKEN);
        startService(intent);
    }
    ...
    private void deleteHmsMessageServiceToken() {
        ...
        Intent intent = new Intent(this, r800zzbrowserHmsMessageService.class);
        intent.putExtra(r800zzbrowserHmsMessageService.COMMAND, r800zzbrowserHmsMessageService.COMMAND_DELETE_TOKEN);
        startService(intent);
    }
    ...
    private void stopHmsMessageService() {
        ...
        Intent intent = new Intent(this, r800zzbrowserHmsMessageService.class);
        intent.putExtra(r800zzbrowserHmsMessageService.COMMAND, r800zzbrowserHmsMessageService.COMMAND_STOP_SERVICE);
        startService(intent);
    }
