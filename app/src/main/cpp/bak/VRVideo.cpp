...
const std::string sChromaKeyFragmentShader = R"SHADER(
#version 100
...
//chromakey
    ...
    vrb::ProgramPtr program =
    create->GetProgramFactory()->CreateProgram(
        create,
        vrb::FeatureSurfaceTexture | vrb::FeatureHighPrecision,
        sChromaKeyFragmentShader);
//
