...
//chromakey
/*
WidgetPtr vrVideoWidgetBackup;
QuadPtr vrVideoQuadBackup;
CylinderPtr vrVideoCylinderBackup;
*/
//
...
//chromakey
/*
m.vrVideoWidgetBackup = widget;
m.vrVideoQuadBackup = widget->GetQuad();
m.vrVideoCylinderBackup = widget->GetCylinder();
...
QuadPtr noLayerQuad =
    Quad::Create(m.create, worldWidth, worldHeight, nullptr);

widget->SetQuad(noLayerQuad);
*/
//
...
//chromakey
/*
  if (m.vrVideoWidgetBackup) {
    if (m.vrVideoCylinderBackup) {
      m.vrVideoWidgetBackup->SetCylinder(
          m.vrVideoCylinderBackup);
    } else if (m.vrVideoQuadBackup) {
      m.vrVideoWidgetBackup->SetQuad(
          m.vrVideoQuadBackup);
    }

    m.vrVideoWidgetBackup->RecreateSurface();
  }

  m.vrVideoWidgetBackup = nullptr;
  m.vrVideoQuadBackup = nullptr;
  m.vrVideoCylinderBackup = nullptr;
*/
//
  if (m.skybox) {
