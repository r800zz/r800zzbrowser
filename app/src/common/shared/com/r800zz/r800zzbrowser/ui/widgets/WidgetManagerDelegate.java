...
public interface WidgetManagerDelegate {
    ...
    void toggleAiPassthrough(); //r800zz
    void toggleGreenChromaKey(); //r800zz
    void toggleBlackChromaKey(); //r800zz
    void toggleWhiteChromaKey(); //r800zz
    void toggleSkyBlueChromaKey(); //r800zz
    void toggleAutoColorChromaKey(); //r800zz
