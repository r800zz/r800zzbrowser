...
public class VideoProjectionMenuWidget extends MenuWidget {
    ...
    @IntDef(value = { VIDEO_PROJECTION_NONE, VIDEO_PROJECTION_3D_SIDE_BY_SIDE, VIDEO_PROJECTION_360,
                      ...
                      VIDEO_PROJECTION_3D_TOP_BOTTOM,VIDEO_PROJECTION_180_2D_TO_VR })
    ...
    public static final int VIDEO_PROJECTION_180_2D_TO_VR = 7; //r800zz
    ...
    private void createMenuItems() {
        ...
        mItems.add(new ProjectionMenuItem(VIDEO_PROJECTION_180_2D_TO_VR, //r800zz
        getContext().getString(R.string.video_mode_180_2d_to_vr), //r800zz
        R.drawable.ic_icon_videoplayback_180)); //r800zz
    ...
    public static @VideoProjectionFlags int getAutomaticProjection(String aURL, AtomicBoolean autoEnter) {
        ...
        } else if (projection.startsWith("1802d") || projection.startsWith("180_2d")) { //r800zz
            return VIDEO_PROJECTION_180_2D_TO_VR; //r800zz
