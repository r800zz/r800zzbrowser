...
import static com.r800zz.r800zzbrowser.ui.widgets.settings.SettingsView.SettingViewType.FXA;
...
import com.r800zz.r800zzbrowser.browser.HistoryStore;
...
import com.r800zz.r800zzbrowser.browser.components.r800zzbrowserEngineSession;
...
public class Windows implements TrayListener, TopBarWidget.Delegate, TitleBarWidget.Delegate,
    ...
    // launch r800zzbrowser in immersive mode automatically
    private static final String PARENT_ELEMENT_XPATH_PARAMETER = "r800zzbrowser-launchimmersive-parentElementXPath";
    private static final String TARGET_ELEMENT_XPATH_PARAMETER = "r800zzbrowser-launchimmersive-targetElementXPath";
    private static final String IMMERSIVE_EXTENSION_ID = "r800zzbrowser-launchimmersive@r800zz.com";
    private static final String IMMERSIVE_EXTENSION_URL = "resource://android/assets/extensions/r800zzbrowser_launchimmersive/";
    ...
    public void onTabSelect(Session aTab) {
        ...
        if (windowToMove != null && windowToMove != targetWindow) {
            ...
            Session popUpSession = ComponentsAdapter.get().getStore().getState().getExtensions().values().stream()
                    ...
                    .map(extensionState -> ((r800zzbrowserEngineSession) extensionState.getPopupSession()).getSession())
