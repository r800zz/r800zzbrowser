...
import com.r800zz.r800zzbrowser.databinding.MediaControlsBinding;
import com.r800zz.r800zzbrowser.ui.views.MediaSeekBar;
import com.r800zz.r800zzbrowser.ui.views.VolumeControl;
...
public class MediaControlsWidget extends UIWidget implements WMediaSession.Delegate {
    ...
    private Runnable mChromaKeyHandler; //r800zz
    ...
    private void updateUI() {
        ...
        mBinding.mediaChromaKeyButton.setOnClickListener(v -> { //r800zz
            if (mChromaKeyHandler != null) {
                mChromaKeyHandler.run();
            }
            //mBinding.mediaChromaKeyButton.requestFocusFromTouch();
        });
    ...
    public void setChromaKeyHandler(Runnable aRunnable) { //r800zz
        mChromaKeyHandler = aRunnable;
    }
