...
import com.r800zz.r800zzbrowser.browser.api.WAllowOrDeny;
import com.r800zz.r800zzbrowser.browser.api.WAutocomplete;
import com.r800zz.r800zzbrowser.browser.api.WResult;
import com.r800zz.r800zzbrowser.browser.api.WSession;
import com.r800zz.r800zzbrowser.browser.api.WSlowScriptResponse;
import com.r800zz.r800zzbrowser.browser.components.LoginDelegateWrapper;
import com.r800zz.r800zzbrowser.browser.engine.Session;
import com.r800zz.r800zzbrowser.browser.engine.SessionState;
import com.r800zz.r800zzbrowser.browser.engine.SessionStore;
import com.r800zz.r800zzbrowser.db.SitePermission;
import com.r800zz.r800zzbrowser.ui.viewmodel.SitePermissionViewModel;
...
import com.r800zz.r800zzbrowser.ui.widgets.prompts.AlertPromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.AuthPromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.ChoicePromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.ColorPromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.ConfirmPromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.DateTimePromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.FilePromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.PromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.SaveLoginPromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.SelectLoginPromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.prompts.TextPromptWidget;
import com.r800zz.r800zzbrowser.ui.widgets.settings.SettingsView;
...
public class PromptDelegate implements
    ...
    public WResult<PromptResponse> onFilePrompt(@NonNull final WSession session, @NonNull final WSession.PromptDelegate.FilePrompt prompt) {
        Log.d("PromptDelegate", "Launching System File Manager...");
        final WResult<PromptResponse> result = WResult.create();

        // Ensure we extract VRBrowserActivity from the context stack
        Context context = mContext;
        while (context instanceof android.content.ContextWrapper) {
            if (context instanceof VRBrowserActivity) break;
            context = ((android.content.ContextWrapper) context).getBaseContext();
        }

        if (context instanceof VRBrowserActivity) {
            ((VRBrowserActivity) context).openSystemFileChooser(prompt, result);
        } else {
            Log.e("PromptDelegate", "Could not find VRBrowserActivity in context stack: " + mContext.getClass().getName());
