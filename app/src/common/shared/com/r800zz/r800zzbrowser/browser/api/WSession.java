...
public interface WSession {
    ...
    interface PromptDelegate {
        ...
        interface PopupPrompt extends WSession.PromptDelegate.BasePrompt {
             ...
             *
             * @param response An {@link com.r800zz.r800zzbrowser.browser.api.AllowOrDeny} specifying whether to allow or deny the popup.
             * @return A {@link WSession.PromptDelegate.PromptResponse} which can be used to complete the {@link WResult}
             *     associated with this prompt.
             */
            @UiThread
         ...
         * @return A {@link WResult} resolving to {@link com.r800zz.r800zzbrowser.browser.api.AllowOrDeny#ALLOW} if the page is allowed
         *     to continue with the navigation or {@link com.r800zz.r800zzbrowser.browser.api.AllowOrDeny#DENY} otherwise.
         */
        @UiThread
        default @Nullable
