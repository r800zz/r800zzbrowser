...
public class SettingsStore {
    ...
    //public final static String ENV_DEFAULT = "cobblestone_street_night";
    ...
    private void updateRemoteContent(String endpoint, int prefsKey, Consumer<String> onContentAvailable) {
        if (StringUtils.isEmpty(endpoint) || endpoint.equals("about:blank") || !endpoint.startsWith("http")) {
            Log.d(LOGTAG, "Skipping remote content update for: " + endpoint);
            return;
        }
