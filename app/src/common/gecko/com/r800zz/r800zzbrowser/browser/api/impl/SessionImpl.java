...
import com.r800zz.r800zzbrowser.browser.api.WTextInput;
...
public class SessionImpl implements WSession {
    ...
    private static final String WOLVIC_USER_AGENT_MOBILE = GeckoSession.getDefaultUserAgent() + " r800zzbrowser/" + BuildConfig.VERSION_NAME;
