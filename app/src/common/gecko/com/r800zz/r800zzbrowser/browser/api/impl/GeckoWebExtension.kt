...
import com.r800zz.r800zzbrowser.browser.api.await
import com.r800zz.r800zzbrowser.browser.components.await as wAwait
...
class GeckoWebExtension(
    ...
    override fun registerTabHandler(tabHandler: TabHandler, defaultSettings: Settings?) {
        ...
        val tabDelegate = object : GeckoNativeWebExtension.TabDelegate {
            ...
            override fun onNewTab(
                ...
                val geckoEngineSession = r800zzbrowserEngineSession(session)
                tabHandler.onNewTab(
                        this@GeckoWebExtension,
                        geckoEngineSession,
    ...
    private fun getGeckoSession(engineSession: EngineSession): GeckoSession? {
        return ((engineSession as r800zzbrowserEngineSession).session.wSession as? SessionImpl)?.geckoSession
    }
}
